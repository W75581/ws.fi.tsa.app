					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TSA &amp; Intercompany Invoicing",
									"targetURL": "#wsfitsaapp-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"wsfitsaapp-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ws.fi.tsa.app",
									"url": sap.ui.require.toUrl("ws/fi/tsa/app")
								}
							}
						}
					}
